...
logo_file = os.path.join(BASE_DIR, "frontend", "img", "sutech-mark-blue.png")
...
if header_match:
    ...
    reporter.check("img/sutech-mark-blue.png" in h_text, "Наличие выбранного логотипа Su-Tech в <header>")
